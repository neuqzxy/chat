...
$(function () {
    ...
    let showMessage = function(message,username,imgUrl) {
        if(username === _username) {
            $('#content').append(`<p class="bg-primary" style=' float:right; max-width: 500px; min-width: 230px; word-wrap: break-word; padding-right: 20px;'><svg class="icon img-circle" aria-hidden="true" style="font-size: 2em;"><use xlink:href="#icon-yonghu"></use></svg><strong style="font-size: 1.5em;">${username}&nbsp;</strong>: &nbsp;<span>&nbsp;${message}</p>`);
        } else {
            $('#content').append(`<p class="bg-info" style="float:left; text-indent: 20px; max-width: 500px; min-width: 230px; word-wrap: break-word;"><svg class="icon img-circle" aria-hidden="true" style="font-size: 2em;"><use xlink:href="#${randomChoose(imgUrl)}"></use></svg><strong style="font-size: 1.5em;">${username}&nbsp;</strong>: &nbsp;<span>&nbsp;${message}</p>`);
        }
        initHeight();
    };
    ...
    let showImg = function(DataUrl,username,imgUrl) {
        if(username === _username) {
            $('#content').append(`<p class="bg-primary" style=' max-width: 500px; min-width: 230px; word-wrap: break-word;'><svg class="icon img-circle" aria-hidden="true" style="font-size: 2em; padding-right: 20px;"><use xlink:href="#icon-yonghu"></use></svg><strong style="font-size: 1.5em;">${username}&nbsp;</strong>: &nbsp;<img class="img-thumbnail" src="${DataUrl}" style="max-height: 100px"/></p>`);
        } else {
            $('#content').append(`<p class="bg-info" style='text-indent: 20px;  max-width: 500px; min-width: 230px; word-wrap: break-word;'><svg class="icon img-circle" aria-hidden="true" style="font-size: 2em;"><use xlink:href="#${randomChoose(imgUrl)}"></use></svg><strong style="font-size: 1.5em;">${username}&nbsp;</strong>: &nbsp;<img class="img-thumbnail" src="${DataUrl}" style="max-height: 100px"/></p>`);
        }
        initHeight();
    };
